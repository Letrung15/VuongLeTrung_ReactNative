    ...
    <View className="flex-row justify-center items-center">
      ...
      <View className="flex-1 flex-row  justify-between items-center w-[100%] pl-2">
        <View>
          ...
          <Text className="text-xs">Số lượng: {qty}</Text>
          <Text className="text-xs">Ngày: {date}</Text>
          <Text className="text-xs">Mã đơn hàng: <Text className="font-semibold">#{orderId}</Text></Text>
        </View>
